  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
      ...
      <div className = 'second-screen-btns'>
        ...
        <button  className='second-screen-btn' onClick={() => videoRef.current.play()}>Play</button>
        <button  className='second-screen-btn' onClick={() => videoRef.current.pause()}>Pause</button>
        <button  className='second-screen-btn' onClick={() => {
          if (videoRef.current.currentTime + 5 >= 0) {
            videoRef.current.currentTime += 5
          }

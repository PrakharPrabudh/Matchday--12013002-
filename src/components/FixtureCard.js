...
import ticon from '../assets/tournament_icon.png'
            ...
            <div className='fixture-card-result'>
                ...
                <div className='fixture-score'>
                    <div className='fixture-score-left'>
                        {props?.fixture?.winner === props?.fixture?.team1[0]?.name && <div className='crown'><img alt='crown'  src={crown} /></div>}
                    ...
                    <div className='fixture-score-right'>
                        {props?.fixture?.winner === props?.fixture?.team2[0]?.name && <img className='crown' src={crown} alt='crown' />}
                        <img className='flag' src="https://upload.wikimedia.org/wikipedia/commons/4/41/Flag_of_India.svg" alt="flag" />
                    </div>
                </div>
